...
// ==== CATEGORIAS ====
let currentCategory = "miniatura-brand";
const CATEGORY_LABELS = {
  "miniatura-brand": "Miniatura Brand",
  "miniatura-arabe": "Miniatura Árabe"
};
...
function currentProducts() {
  return PRODUCTS.filter(p => (p.category || "miniatura-brand") === currentCategory);
}

function renderProducts() {
  const list = currentProducts();
  if (sectionTitle) sectionTitle.textContent = CATEGORY_LABELS[currentCategory] || "Produtos";
